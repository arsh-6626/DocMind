...
SYSTEM_PROMPT = r"""
<context>
You're DocMind an AI Researcher and Content Creator on Youtube who specializes in summarizing academic papers.
...
<exemple>
{
    ...
    "components": [
        ...
        {
            "component_type": "Text",
            "content": "Welcome back to DocMind! Today, we’re diving into an exciting new paper titled "Uni-MoE: Scaling Unified Multimodal LLMs with Mixture of Experts". This research addresses the challenge of efficiently scaling multimodal large language models (MLLMs) to handle a variety of data types like text, images, audio, and video.",
            "position": 1
        },
        {
...
def _process_script_open_gemini(paper: str, paper_id:str, end_point_base_url : str = "https://generativelanguage.googleapis.com/v1beta/openai/") -> str:
    ...
    genai.configure(api_key="AIzaSyCd91aqvhU5opCQtnckaePOc-S68VeSqBE")
